...
INSERT INTO `likes` VALUES ('AndroZa','36',1);
...
CREATE TABLE `orders` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=latin1 COMMENT='all the users and their orders';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reviews` VALUES (29,1,'AndroZa','not the best movie.',12,4,5),(33,1,'AndroZa','××—×œ×” ×¡×¨×˜',0,0,5),(34,1,'AndroZa','jjjjj',0,0,5),(35,1,'AndroZa','dubi\r\n',0,0,5),(36,1,'AndroZa','××—×œ×” ×¡×¨×˜',1,0,5),(37,1,'AndroZa','aaa',0,0,5);
...
INSERT INTO `users` VALUES (6,'AndroZa','Nathan','Tregub','nathan0812@gmail.com','$2y$10$MBzJWVH2quoadpsKv1SYU.QzFdUChXzS4RMzJFoUo9Om7BR5igS8e',19,1),(8,'test','matest','test','samlamla@dudu.com','$2y$10$azNiHM5bc6P7A5PJe0M.4OnEExzQ3KkdvsMlnM3ULE7DDKTRs8Y9C',19,0);
...
-- Dump completed on 2017-05-12 22:37:11
